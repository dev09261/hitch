...
class ShowDialogs {
  ...
  static void showDeleteAccountDialog(
      {required BuildContext context, required VoidCallback onDeleteTap}) {
                                  ...
                                  if (auth.currentUser != null) {
                                    try {
                                      ...
                                      if (user != null) {
                                        ...
                                        QuerySnapshot contactedPlayersSnapshot =
                                            await FirebaseFirestore.instance
                                                .collection(userCollection)
                                                .doc(user.uid)
                                                .collection(
                                                    contactedPlayersCollection)
                                                .get();

                                        for (var doc
                                            in contactedPlayersSnapshot.docs) {
                                          await doc.reference.delete();
                                        }
                                        ...
                                        debugPrint(
                                            "Deleting the document, Now going back");
                                        onDeleteTap();
                                        isDeleting = false;
                                      } else {}
                                    } catch (e) {
  ...
  static void showSuccessBottomSheet(BuildContext context) {
    ...
    Future.delayed(const Duration(seconds: 4), () {
      ...
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (ctx) => const PermissionsPage()),
          (route) => false);
    });
  }
                          ...
                          if (selectedGender.isNotEmpty) {
                            ...
                            LoggedInUserProvider loggedInUserProvider =
                                Provider.of<LoggedInUserProvider>(context,
                                    listen: false);
                            try {
                              await userAuthService.updateUserInfo(
                                  updatedMap: {'gender': selectedGender});
  ...
  static void showDeletePhotoDialog(
      {required BuildContext context, required VoidCallback onDeleteTap}) {
    showDialog(
        context: context,
        builder: (ctx) {
