...
class LoggedInUserProvider extends ChangeNotifier {
  ...
  void updateDeclinedUsers(String userID) {
    ...
    UserModel updatedUser = UserModel(
        ...
        playerTypePadel: _user.playerTypePadel,
        ...
        requestSentToUserIDs:
            List.from(_user.requestSentToUserIDs), // Mutable copy
        requestReceivedFromUserIDs:
            List.from(_user.requestReceivedFromUserIDs), // Mutable copy
        declinedRequestsUserIDs: List.from(_user.declinedRequestsUserIDs)
          ..add(userID), // Add during copy
        ...
        padelBallPlayerLevel: _user.padelBallPlayerLevel,
        ...
        coachPadelBallExperienceLevel: _user.coachPadelBallExperienceLevel,
