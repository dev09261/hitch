...
class PickedSportVideosPhotosWidget extends StatelessWidget{
  const PickedSportVideosPhotosWidget({super.key, required this.pickedFiles, required this.onPickSportVideos, this.onPhotosTap});
    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            flex: 3,
            child: SelectedVideosPhotosGridviewWidget(selectedPhotosVideos: pickedFiles, onTap: onPhotosTap,),),
